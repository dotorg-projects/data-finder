...
// Author  : .ORG Projects
// Updated : 05/14/2026
// Note    : Copyright 2026, .ORG Projects, All rights reserved
//           Portions Copyright 2014-2026, Eric Woodruff, All rights reserved
//           Portions Copyright 2010-2014 Microsoft, All rights reserved
//
// This file contains the methods necessary to implement the language filtering, collapsible section,
// copy to clipboard options, and light/dark theme toggle.
//
...
// 05/14/2026  ORG  Added light/dark theme toggle with localStorage persistence
//===============================================================================================================

// Ignore Spelling: fti json Resizer mousedown mouseup mousemove

//===============================================================================================================
// This section contains the methods used to implement the light/dark theme toggle

// Apply the saved theme immediately to avoid flash of wrong theme
(function () {
...
// Inject the toggle button into the page header and wire up its behavior
function InitializeThemeToggle() {
    if (document.getElementById("ThemeToggle") !== null)
        return;

    var header = document.querySelector(".pageHeader .level-right");
...
// Perform a search using client-side script
